            ...
            let pendidikanItem = `
                <div class="pendidikan-item">
                    <div class="text-pendidikan">
                        ...
                        <input type="text" name="info-relevan[]" value="${infoEdu}" class="info-relevan" readonly>
                    </div>
            ...
            let pengalamanItem = `
                <div class="pengalaman-item">
                    <div class="text-pengalaman">
                        ...
                        <input type="text" name="info-relevanEx[]" value="${infoEx}" class="info-relevan" readonly>
                    </div>
